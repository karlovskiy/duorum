...
<c:url var="formAction" value="/units/${unit.id}"/>
<form:form commandName="unit" action="${formAction}" cssClass="form-horizontal" role="form">
    ...
    <spring:bind path="designation">
        <div class="form-group ${status.error ? "has-error" : ""}">
            ...
            <div class="col-sm-3">
                <form:input id="designation" path="designation" readonly="true"
                            cssClass="form-control uneditable-input}"/>
    ...
    <div class="form-group">
        <div class="btn-group col-sm-offset-2 col-sm-10">
            ...
            <a href="<c:url value="/units/${unit.id}"/>" class="btn btn-default">
