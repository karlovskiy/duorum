...
<script type="text/javascript" src="<c:url value="/resources/${application.version}/js/duorum.js"/>"></script>
<script type="text/javascript">
    $(document).ready(function () {
        duorum.initModules('<tiles:getAsString name="modules" ignore="true"/>');
    });
</script>
</body>
</html>
